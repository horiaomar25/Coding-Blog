...
$catalogue = new MessageCatalogue('sq', array (
  'validators+intl-icu' => 
  array (
    'post.slug_unique' => 'Ky titull është përdorur në një artikull tjetër. Titujt duhet të jenë unikë.',
    'post.blank_summary' => 'Vendos një përmbledhje!',
    'post.blank_content' => 'Artikulli yt duhet të ketë ca përmbajtje!',
    'post.too_short_content' => 'Përmbajtja e artikullit është shumë e shkurtër (të paktën { limit } karaktere)',
    'post.too_many_tags' => 'Shumë etiketa (të shumtën { limit } etiketa)',
    'comment.blank' => 'Komenti nuk mund të jetë bosh!',
    'comment.too_short' => 'Komenti është shumë i shkurtër (të paktën { limit } karaktere)',
    'comment.too_long' => 'Komenti është shumë i gjatë (të shumtën { limit } karaktere)',
    'comment.is_spam' => 'Përmbajtja e këtij komenti njihet si “spam”.',
  ),
  'validators' => 
  array (
  ...
  array (
    'note' => 'SHËNIM',
    'tip' => 'SUGJERIM',
    'not_available' => 'Nuk gjendet',
    'mit_license' => 'Liçencë MIT',
    'http_error.name' => 'Gabim {status_code, number}',
    'http_error.description' => 'Një gabim i panjohur (HTTP {status_code, number}) ndaloi plotësimin e kërkesës.',
    'http_error.suggestion' => 'Provo të rifreskosh faqen pas pak ose <a href="{url}">kthehu në ballinë</a>.',
    'http_error_403.description' => 'Mungojnë të drejta për të qasur këtë burim.',
    'http_error_403.suggestion' => 'Kërko pranë një administratori të japë qasje këtij burimi.',
    'http_error_404.description' => 'Faqja e kërkuar nuk u gjend.',
    'http_error_404.suggestion' => 'Kontrollo të jetë shkruar saktë URL-ja ose <a href="{url}">kthehu në ballinë</a>.',
    'http_error_500.description' => 'Ndodhi një gabim i brendshëm server-i (shërbyesi).',
    'http_error_500.suggestion' => 'Provo të rifreskosh faqen pas pak ose <a href="{url}">kthehu në ballinë</a>.',
    'title.homepage' => 'Mirë se erdhe në aplikacionin <strong>“Symfony Demo”</strong>',
    'title.source_code' => 'Kodi burimor i përdorur për të shfaqur këtë faqe',
    'title.controller_code' => 'Kodi i kontrollorit',
    'title.twig_template_code' => 'Kodi “Twig”',
    'title.login' => 'Hyrje e sigurtë',
    'title.post_list' => 'Lista e artikujve',
    'title.edit_post' => 'Redakto artikullin #{id, number}',
    'title.add_comment' => 'Shto një koment',
    'title.comment_error' => 'Ndodhi një gabim gjatë publikimit të komentit tënd',
    'title.edit_user' => 'Redakto përdoruesin',
    'title.change_password' => 'Ndrysho fjalëkalimin',
    'action.show' => 'Shfaq',
    'action.show_post' => 'Shfaq artikullin',
    'action.show_code' => 'Shfaq kodin',
    'action.edit' => 'Redakto',
    'action.edit_post' => 'Redakto artikullin',
    'action.save' => 'Ruaj ndryshimet',
    'action.delete_post' => 'Fshi artikullin',
    'delete_post_modal.title' => 'I/E sigurtë që dëshiron të fshish këtë artikull?',
    'delete_post_modal.body' => 'Ky veprim nuk mund të zhbëhet.',
    'label.delete_post' => 'Fshi artikullin',
    'label.cancel' => 'Ndalo',
    'action.create_post' => 'Shto një artikull të ri',
    'label.create_post' => 'Ruaj',
    'label.save_and_create_new' => 'Ruaj dhe shkruaj tjetër',
    'action.back_to_list' => 'Kthehu në listën e artikujve',
    'action.publish_comment' => 'Publiko komentin',
    'action.sign_in' => 'Hyr',
    'action.browse_app' => 'Shfleto aplikacionin',
    'action.browse_admin' => 'Shfleto panelin e administrimit',
    'action.edit_user' => 'Redakto përdoruesin',
    'action.change_password' => 'Ndrysho fjalëkalimin',
    'action.close' => 'Mbyll',
    'label.title' => 'Titulli',
    'label.author' => 'Autori',
    'label.author_email' => 'Email-i i autorit',
    'label.username' => 'Emri i përdoruesit',
    'label.fullname' => 'Emri i plotë',
    'label.email' => 'Email',
    'label.password' => 'Fjalëkalimi',
    'label.remember_me' => 'Mbamë të futur në llogari',
    'label.current_password' => 'Fjalëkalimi i tanishëm',
    'label.new_password' => 'Fjalëkalimi i ri',
    'label.new_password_confirm' => 'Konfirmo fjalëkalimin',
    'label.role' => 'Roli',
    'label.content' => 'Përmbajtja',
    'label.summary' => 'Përmbledhja',
    'label.published_at' => 'Publikuar më',
    'label.tags' => 'Etiketa',
    'label.actions' => 'Veprime',
    'title.post_new' => 'Shkrimi i artikullit',
    'action.edit_contents' => 'Redakto përmbajtjen',
    'menu.toggle_nav' => 'Ndrysho shfletimin',
    'menu.choose_language' => 'Zgjidh gjuhën',
    'menu.post_list' => 'Lista e artikujve',
    'menu.back_to_blog' => 'Kthehu në blog',
    'menu.homepage' => 'Ballina',
    'menu.admin' => 'Paneli i administrimit',
    'menu.user' => 'Llogaria',
    'menu.logout' => 'Dil',
    'menu.rss' => 'RSS-ja e blogut',
    'menu.search' => 'Kërko',
    'post.to_publish_a_comment' => 'për të publikuar një koment',
    'post.num_comments' => '{count, plural, one {# koment} other {# komente}}',
    'post.commented_on' => 'ka komentuar më',
    'post.no_comments' => 'Komento i pari/e para.',
    'post.no_posts_found' => 'Asnjë artikull.',
    'post.created_successfully' => 'Postimi u ruajt!',
    'post.updated_successfully' => 'Postimi u përditësua!',
    'post.deleted_successfully' => 'Postimi u fshi!',
    'post.search_for' => 'Kërko për...',
    'post.search_no_results' => 'Asnjë rezultat',
    'user.updated_successfully' => 'Përdoruesi u përditësua me sukses!',
    'notification.comment_created' => 'Dikush komentoi artikullin tënd!',
    'notification.comment_created.description' => 'Dikush la një koment të ri tek artikulli: "{title}". Komenti mund të lexohet në këtë <a href="{link}">lidhëz</a>',
    'help.app_description' => 'Ky është një <strong>aplikacion shembull</strong> i krijuar me “Symfony Framework” për të treguar mënyrën e rekomanduar për të zhvilluar aplikacione me “Symfony”.',
    'help.show_code' => 'Kliko këtë buton për shfaqur kodin burimor të <strong>kontrollorëve</strong> e <strong>shablloneve (template)</strong> të përdorura për të shfaqur këtë faqe.',
    'help.browse_app' => 'Shfleto <strong>seksionin publik</strong> të aplikacionit.',
    'help.browse_admin' => 'Shfleto <strong>panelin e administrimit</strong> të aplikacionit.',
    'help.login_users' => 'Provo një prej përdoruesëve të mëposhtëm',
    'help.role_user' => 'përdorues i zakonshëm',
    'help.role_admin' => 'admimistrator',
    'help.reload_fixtures' => 'Nëse këta përdorues nuk punojnë, ngarkoni përsëri të dhënat e aplikacionit duke ekzekuatuar këtë komandë në terminal:',
    'help.add_user' => 'Nëse dëshiron të shtosh përdorues të rinj, ekzekuto këtë komandë:',
    'help.more_information' => 'Për më shumë informacion, vizito <a href="https://symfony.com/doc">dokumentacionin e “Symfony”</a>.',
    'help.post_summary' => 'Përmbledhjet nuk mund të kenë “Markdown” ose HTML; vetëm tekst të thjeshtë.',
    'help.post_publication' => 'Vendos datën në të ardhmen për të planifikuar publikimin e artikullit.',
    'help.post_content' => 'Përdor “Markdown” për të formatuar përmbajtjen e artikullit. HTML-ja lejohet gjithashtu.',
    'help.comment_content' => 'Komentet që nuk i përmbahen kodit tonë të sjelljes do të kontrollohen.',
    'info.change_password' => 'Pas ndryshimit të fjalëkalimit, llogaria do të dalë nga aplikacioni.',
    'rss.title' => '“Symfony Demo” blog',
    'rss.description' => 'Postimet më të reja të publikuara në “Symfony Demo” blog',
    'paginator.previous' => 'Mbrapa',
    'paginator.next' => 'Para',
    'paginator.current' => '(tani)',
  ),
));
