...
$catalogue = new MessageCatalogue('lt', array (
  ...
  array (
    ...
    'http_error.suggestion' => 'Pabandyke užkrauti puslapį vėliau arba <a href="{url}">grįžti į pagrindinį puslapį</a>.',
    'http_error_403.description' => 'Neturite teisės peržiūrėti šio turinio.',
    'http_error_403.suggestion' => 'Paprašykite sistemos administratoriaus, kad suteiktų prieigą prie šio turinio.',
    'http_error_404.description' => 'Puslapis nerastas.',
    'http_error_404.suggestion' => 'Patikrinkite ar gerai įvestas adresas arba <a href="{url}">grįžti į pagrindinį puslapį</a>.',
    'http_error_500.description' => 'Įvyko vidinė serverio klaida.',
    'http_error_500.suggestion' => 'Pabandyke užkrauti puslapį vėliau arba <a href="{url}">grįžti į pagrindinį puslapį</a>.',
    ...
    'delete_post_modal.title' => 'Ar tikrai norite ištrinti įrašą?',
    ...
    'label.remember_me' => 'Prijungti automatiškai',
    ...
    'notification.comment_created.description' => 'Jūsų įrašas "{title}" gavo naują komentarą. Kad peržiūrėti komentarą, galite paspausti šią <a href="{link}">nuorodą</a>',
    'help.app_description' => 'Tai yra <strong>demo puslapis</strong> sukurtas su Symfony Framework parodant tinkamą Symfony panaudojimą.',
    ...
    'help.more_information' => 'Norėdami gauti daugiau informacijos, peržiūrėkite <a href="https://symfony.com/doc">Symfony dokumentaciją</a>.',
    'help.post_summary' => 'Santrauka negali būti su Markdown ar HTML žymomis, tik paprastas tekstas',
    'help.post_publication' => 'Nustatykite datą ateityje, kad suplanuotumėte blogo įrašo paskelbimą.',
    'help.post_content' => 'Turinį galima formatuoti su Markdown ir HTML žymomis.',
