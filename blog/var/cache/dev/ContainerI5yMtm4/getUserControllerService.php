...
class getUserControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.Ao8TovP'] ?? $container->load('get_ServiceLocator_Ao8TovPService'))->withContext('App\\Controller\\UserController', $container));
